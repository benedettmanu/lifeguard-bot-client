...
import { PrivacyPolicy } from "@/styles/pages/PolicyPrivacy";

const PoliticaPrivacidade: React.FC = () => {
   return (
      <Container>
         <Head>
            <title>Política de Privacidade | Bot Salva-Vidas</title>
         </Head>
         ...
         <PrivacyPolicy>
            <section id="privacyPolicy">
               ...
               <br />
               <p>
                  A sua privacidade é importante para nós. É política do Bot Salva-Vidas respeitar a sua privacidade em relação a qualquer
                  informação sua que possamos coletar no site
                  Bot Salva-Vidas, e outros
                  ...
                  mais relevantes em toda a Web e limitar o número de vezes que
                  um determinado anúncio é exibido para você.
                  <br />
                  ...
                  <br />
                  <br />
                  <span id="boldText">Compromisso do Usuário</span>
                  <br />
                  <br />
                  O usuário se compromete a fazer uso adequado dos conteúdos e
                  da informação que o Bot Salva-Vidas oferece no site e com caráter
                  ...
                  (softwares) do Bot Salva-Vidas, de seus fornecedores ou terceiros,
                  ...
                  <br />
                  <br />
                  <span id="boldText">Mais informações</span>
                  <br />
                  <br />
